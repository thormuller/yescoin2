...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/yescoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Yescoin"),
     ...
     * override -datadir in the yescoin.conf file in the default data directory
     * (to be consistent with yescoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
