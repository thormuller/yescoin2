...
/* YescoinGUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Yescoin"
#define QAPP_ORG_DOMAIN "yescoin.org"
#define QAPP_APP_NAME_DEFAULT "Yescoin-Qt"
#define QAPP_APP_NAME_TESTNET "Yescoin-Qt-testnet"
