...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        QString amount = "<b>" + YescoinUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), rcp.amount);
        amount.append("</b>");
    ...
    processSendCoinsReturn(prepareStatus,
        YescoinUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), currentTransaction.getTransactionFee()));
    ...
    if(txFee > 0)
    {
        ...
        questionString.append(YescoinUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), txFee));
    ...
    foreach(YescoinUnits::Unit u, YescoinUnits::availableUnits())
    {
        if(u != model->getOptionsModel()->getDisplayUnit())
            alternativeUnits.append(YescoinUnits::formatWithUnit(u, totalAmount));
    }
    questionString.append(tr("Total Amount %1 (= %2)")
        .arg(YescoinUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), totalAmount))
                                 ...
                                 qint64 watchBalance, qint64 watchUnconfirmedBalance, qint64 watchImmatureBalance)
{
    ...
    if(model && model->getOptionsModel())
    {
        ui->labelBalance->setText(YescoinUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), balance));
    }
}
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        CYescoinAddress addr = CYescoinAddress(text.toStdString());
