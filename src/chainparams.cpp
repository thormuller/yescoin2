...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "Yescoin is a community currency that you will love";
        ...
        //vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.yescoin.dashjr.org"));
        //vSeeds.push_back(CDNSSeedData("yescoinstats.com", "seed.yescoinstats.com"));
        //vSeeds.push_back(CDNSSeedData("bitnodes.io", "seed.bitnodes.io"));
        //vSeeds.push_back(CDNSSeedData("open-nodes.org", "seeds.yescoin.open-nodes.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("yescoin.petertodd.org", "testnet-seed.yescoin.petertodd.org"));
