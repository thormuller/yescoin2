// Copyright (c) 2011-2014 The Yescoin Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CYescoinSecret::SetString tests isValid, whereas CYescoinAddress does not!
