// Copyright (c) 2013-2014 The Yescoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
	...
	CYescoinAddress demoAddress = CYescoinAddress(CTxDestination(demoPubkey.GetID()));
	Value retValue;
	...
	BOOST_CHECK(CYescoinAddress(retValue.get_str()).Get() == demoAddress.Get());
	...
	BOOST_CHECK(CYescoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
