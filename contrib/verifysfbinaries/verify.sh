...
###   This script attempts to download the signature file SHA256SUMS.asc from yescoin.org
...
WORKINGDIR="/tmp/yescoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://yescoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://yescoin.org/bin/"
VERSIONPREFIX="yescoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'yescoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[yescoin-]<version>-[rc[0-9]] (example: yescoin-0.9.2-rc1)"
   echo "wget output:"
