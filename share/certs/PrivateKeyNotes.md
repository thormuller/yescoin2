...
unlocked to sign the Yescoin-Qt.app bundle.
...
allowing somebody to distribute a Yescoin-Qt.app or yescoin-qt-setup.exe with a valid
...
that the yescoin-qt.exe file inside the installer had not been tampered with.
