The following is a list of assets used in the yescoin source and their proper attribution.
...
* License: MIT
* Site: [https://yescointalk.org/index.php?topic=15276.0](https://yescointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original yescoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/yescoin.icns, src/qt/res/src/yescoin.svg,
	src/qt/res/src/yescoin.ico, src/qt/res/src/yescoin.png,
	src/qt/res/src/yescoin_testnet.png, docs/yescoin_logo_doxygen.png,
