Yescoin Core version 0.9.1 is now available from:

  https://yescoin.org/bin/0.9.1/
...
yescoind from any pre-0.9.1 version, and have enabled SSL for RPC and
...
installer (on Windows) or just copy over /Applications/Yescoin-Qt (on Mac) or
yescoind/yescoin-qt (on Linux).
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Yescoin Core software:
