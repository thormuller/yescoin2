Yescoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/yescoin/files/Yescoin/yescoin-0.5.4/
...
http://gitorious.org/yescoin/yescoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Yescoin-Qt notifications under Growl 1.3.
Increase required age of Yescoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxYescoin properly when installing Yescoin-Qt over it. (Windows)
