Yescoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/yescoin/files/Yescoin/yescoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Yescoin
...
New/changed settings (command-line or yescoin.conf file)
--------------------------------------------------------
